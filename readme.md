# Kaggle House Prices Analysis: Identifying Value through Environmental Factors
...
**[推理]** ウッドシングル(WdShngl)の屋根を持つ家は、標準的な素材(CompShg)よりも価格が高い傾向にある。屋根の素材は住宅의グレードを判断する重要な指標になりそうだ。
